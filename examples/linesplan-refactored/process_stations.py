...
zero, fragments are connected, station rows are oriented top-to-bottom, and the
top region is split at the keel discontinuity.
"""
...
def process_stations(polylines: Iterable[Polyline3]) -> ProcessedStations:
    ...
    prepared = prepare_station_lines(connected)
...
def prepare_station_lines(polylines: Iterable[Polyline3]) -> tuple[Polyline3, ...]:
    """Trim and orient connected station lines for consistent lofting."""
