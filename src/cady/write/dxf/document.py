...
from cady.geom.helpers import perpendicular
from cady.geom.vec import Vec2
from cady.scene.dxf import HEADER_VARS, AngularDimensionEntity, DimensionEntity, DxfDrawing
from cady.write.dxf.blocks import blocks_section_body, insert_entity
from cady.write.dxf.dimensions import dimension_entities
from cady.write.dxf.emit import pairs
from cady.write.dxf.entities import mtext_entity, shape_entities
from cady.write.dxf.hatch import hatch_entity
from cady.write.dxf.plan import DxfRenderPlan, make_render_plan
from cady.write.dxf.tables import dimstyle_table, layer_table, linetype_table
...
def _dimension_bounds(
    ...
    if isinstance(dimension, AngularDimensionEntity):
        from cady.write.dxf.dimensions import angular_dim_arc_point
