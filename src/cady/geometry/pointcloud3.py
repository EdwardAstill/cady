"""Unconnected 3D point collections with transform and viewer support."""
...
from cady.geometry.polyline3 import Point3Like
...
class PointCloud3:
    ...
    def transformed(self, transform: Transform3) -> PointCloud3:
        ...
        return PointCloud3(Vec3(float(x), float(y), float(z)) for x, y, z in array)
