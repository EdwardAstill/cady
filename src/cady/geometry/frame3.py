"""Local 3D coordinate frames for placing planar geometry."""
...
class Frame3:
    """Right-handed 3D frame with an origin, x-axis, and surface normal."""
    ...
    def transformed(self, transform: Transform3) -> Frame3:
        ...
        return Frame3(origin, x_point - origin, normal_point - origin)
