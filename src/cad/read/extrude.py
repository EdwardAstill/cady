...
Given the raw face list from :func:`cad.read.step.read_step`, this module
...
Usage::
    ...
    from cad.read.step import read_step
    from cad.read.extrude import extract_members_from_faces
