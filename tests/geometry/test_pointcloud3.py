...
from cady.geometry import PointCloud3
...
def test_point_cloud_bounds_array_and_transform() -> None:
    ...
    assert cloud.vertices == ((0.0, 0.0, 0.0), (1.0, -2.0, 3.0))
    assert cloud.bounds() == ((0.0, -2.0, 0.0), (1.0, 0.0, 3.0))
