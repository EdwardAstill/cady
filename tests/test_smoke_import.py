...
def test_preferred_package_imports() -> None:
    ...
    from cady.operations import mesh as mesh_operations
    from cady.operations.mesh import clipping, construction, primitives, topology
    from cady.operations.primitives import cross3
